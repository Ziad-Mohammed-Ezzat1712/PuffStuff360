...
const UPDATE_API = "/api/cart/updateCart.php";

const DELETE_API = "/api/cart/deleteFromCart.php";
const ADD_API = "/api/cart/add.php";
const DISCOUNT_API = `/api/discounts/getDiscountsForUser.php?nocache=${Date.now()}`;
...
export function CartProvider({ children }) {
  ...
  const fetchCart = async () => {
    ...
    try {
      const res = await axios.get(`/api/cart/getCart.php?nocache=${Date.now()}`, authHeader);

 ...
 const { addToCart } = useCart();
  ...
  return (
    <section className="px-4 py-10 ">
      <h2 className="text-white text-left text-3xl font-bold mb-8">Suggestions</h2>
          ...
          >
            ...
            <div className="p-4 rounded-t-2xl space-y-4">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <button className="w-[50%] border border-[#4E0000] hover:bg-[#4E0000] text-[#4E0000] hover:text-white py-2 rounded-lg transition">
                  Buy Now
                </button>

                <button className="w-10 h-10 border border-gray-300 rounded-lg flex items-center justify-center bg-[#4E0000] transition">

...
export default function Shape() {
  ...
  const steps = [
    ...
    { id: 2, name: " Payment method ", path: "/paymentpage" },
    { id: 3, name: "Shipping data", path: "/shippingpage" },
  ...
  return (
    <div className="md:flex hidden justify-center items-center gap-10 px-10 py-10">

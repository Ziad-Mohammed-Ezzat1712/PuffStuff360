...
import { useCart } from "../../Context/CartContext1.jsx";import Device1 from "../../assets/Images/device1.png";
 ...
 const { addToCart } = useCart();
  ...
  return (
    <section className="px-4 py-10">
      <h2 className="text-white text-left text-3xl font-bold mb-8">Offers</h2>

          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-6 bg-white rounded-xl p-6">
                ...
                >
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <p className="text-black mt-1">
                      Nic: <span className="text-gray-400 font-medium">3</span>
                    </p>
                    <p className="text-black mt-1">
                      Size: <span className="text-gray-400 font-medium">100 ML</span>
                    </p>
                    <p className="text-black mt-1">
                      Flavor: <span className="text-gray-400 font-medium">Blue Ice</span>
                    </p>
                  ...
                  <div className="absolute left-[84%] top-[60%] flex gap-4">
                    <div className="flex bg-[#E8E8E8] py-2 px-4 rounded-xl justify-between sm:justify-between items-center gap-4 mt-3 ">
                      ...
                      <span className="text-2xl font-medium px-2 text-black">{item.quantity}</span>
                      <button
              ...
              <Link to="/shippingpage" className="text-white hover:text-white">
                <button className="bg-[#790000] hover:bg-[#8b0101] w-full py-4 rounded-xl font-semibold">
                  Continue to pay
                </button>
              </Link>
            </div>
            ...
            <div className="bg-[#ffffff] p-6 rounded-2xl shadow-lg h-fit sticky top-20">
              ...
              <div className="flex justify-between text-[#6D6D6D] text-lg mb-3">
                <span>Subtotal</span>
                <span className="text-[#000000] font-semibold">{subtotal} EG</span>
              </div>

              {discount > 0 && (
                <div className="flex justify-between text-[#6D6D6D] text-lg mb-3">
                  <span>Discount</span>
                  <span className="text-[#790000] font-semibold">{discount} EG</span>
                </div>
              )}
              ...
              <div className="flex justify-between text-[#000000] text-xl font-medium ">
                <span>Total</span>
                <span className="text-[#000000]">{total} EG</span>
              </div>
            </div>
          </div>
        </>
